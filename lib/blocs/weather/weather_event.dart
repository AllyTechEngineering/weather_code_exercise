...
Defines a concrete subclass of WeatherEvent named FetchWeatherEvent. 
It represents an event where the user wants to fetch weather information for a specific city.
*/
class FetchWeatherEvent extends WeatherEvent {
  final String city;
